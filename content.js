...
function createCredentialsTable(users, { usernameField, passwordField }) {
  ...
  users.forEach(user => {
    ...
    row.innerHTML = `
      ...
      <td class="p-3">
        <button class=" action-button text-red-500 hover:text-red-700 select-credential">Select</button>
      </td>
    `;
...
class CredentialInjector {
  ...
  async createPopupTable({ usernameField, passwordField }) {
    try {
      ...
      tableContainer.appendChild(spaceButton);
...
function createButton() {
  ...
  button.innerHTML = `<div class="container noselect">
